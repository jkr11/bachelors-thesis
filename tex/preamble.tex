...
\usepackage[backend=biber, maxbibnames=2,style=alphabetic, backref,backrefstyle=none]{biblatex}
...
\DeclareFieldFormat[software]{eprint:github}{%
...
%\newtheorem{literature}{Literature}[theorem]
...
\newcommand{\Hom}{\mathrm{Hom}}    % Homomorphism set
