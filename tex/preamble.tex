...
\usepackage[sc]{mathpazo} % Use Palatino for text with smallcaps
\usepackage{eulervm}      % Use Euler VM for the mathematical characters
\usepackage{mathrsfs}     % For the \mathscr font used for sheaves
...
% Format Titles to be Emphasized/Italic
\DeclareFieldFormat
  [article,inbook,incollection,inproceedings,patent,thesis,unpublished]
  {title}{\emph{#1\isdot}}

%This would give a nice format but it is not performant?
...
%}
%
%% Clean up other common fields
%\AtEveryBibitem{
%    \clearfield{issn}
%    \clearfield{language}
%    \clearfield{note}
%    \clearfield{urldate} % Removes "visited on..."
%}
