...
% ==========================================
% Custom Quantum Circuit Macros
% ==========================================

% \drawGate{x}{y}{Label}
% Draws a standard square quantum gate
...
\newcommand{\drawCNOT}[3]{
  ...
  % Target XOR symbol (white filled circle with cross)
...
% \drawMeasurement{x}{y}
% Draws a measurement box with a meter symbol inside
...
% Draws the target gate. (The classical vertical lines are drawn manually in your snippet).
