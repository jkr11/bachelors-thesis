...
\Cref{anyons:sec:topological_quantum_computation} we provide an interpretation of how both
...
We want to build a quantum computer that acts purely on the topological data provided by the anyon theories, or as dubbed by \cite{freedmanNPQuantumField1998}, a \emph{Quantum Field Computer}. To do this we need 3 things:
