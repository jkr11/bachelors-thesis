...
\Cref{anyons:sec:lattice_spin_chains}, we provide a worked examples of how anyons are
...
anyons are their universality for quantum computation. In \Cref{...} we provide an
...
\subsection{Algebraic Theory of Anyons}\label{anyon:sec:algebraic_theory_of_anyons}
...
\subsection{1D Lattice Models \& The Golden Chain}\label{anyon:sec:lattice_spin_chains}
