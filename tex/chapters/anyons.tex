...
The solovay-kitaev theorem guarantees a polylog time and space algorithm for approximating any gate in $\SU(d)$ to a desired accuracy. This, and similar procedures are realized by the functor $\mathrm{compile}$.
