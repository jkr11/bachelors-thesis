...
We can decompose the whole space $\Hom(\tau^{\otimes n+1}, \tau)$ into the local states
  \[
    \Hom(\tau^{\otimes n+1}, \tau) = \bigoplus_{\{x_i\}} \Hom(\tau \otimes \tau, x_1) \otimes \Hom(x_1 \otimes \tau, x_2) \otimes \Hom(x_2 \otimes \tau, x_3) \otimes \cdots \otimes \Hom(x_{n-1} \otimes \tau, \tau )
  \]
...
This is in turn realized on the basis of the intermediate states, and evaluated using the method of exact diagonalization \cite{}. This is extended in \cite{trebstShortIntroductionFibonacci2008a}, with longer ranger interaction. It will become apparent that the construction given in these papers is a manualization of the tensor network constructions we will build here. Generalizations to arbitrary models are given in \cite{gilsAnyonicQuantumSpin2013} as well as \cite{buicanAnyonicChainsTopological2017}. Generalized spin chains and dualities using module categories are given in \cite{eckQuantumLatticeModels2025}.
