The goal of this chapter is to provide a viewpoint on the previous chapters from the perspective of categories. In \Cref{cat:sub:introCat} we provide a short introduction to category theory, from the perspective of quantum parallelism, and the structures we have already met in the discussion on representations and anyons. In \Cref{cat:sub:decomp} we provide the core theory in terms of the decomposition, which is crucial to previous chapters. Naturally, this incurs a rigorous explanation of fusion trees. 
