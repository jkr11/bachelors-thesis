...
\subsection{Review: The Golden Chain}
...
%\end{array}
%\]
Note that this is block diagonal over the fusion channel (TODO: change notation).
...
\]
but this chain would have an infinite Hilber Space? Also, lifting to representation operators reveals that there are infinitely many that are not independent.
