...
\appendix
\section{Appendix}
\subsection{Proofs for \Cref{sect:symmetricTensorNetworks}}
\input{chapters/appendix_symmetry.tex}

\subsection{Supplementary categorical constructions}
\input{chapters/appendix_categories.tex}

\subsection{Overview of existing implementations}
